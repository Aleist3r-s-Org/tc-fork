...
void CharacterDatabaseConnection::DoPrepareStatements()
{
    ...
    PrepareStatement(CHAR_DEL_TRANSMOG_SETS, "DELETE FROM `character_transmogrification_sets` WHERE owner = ?", CONNECTION_ASYNC);
    PrepareStatement(CHAR_SEL_TRANSMOG_SETS, "SELECT `presetid`, `setname`, `setdata` FROM `character_transmogrification_sets` WHERE owner = ?", CONNECTION_ASYNC);
    PrepareStatement(CHAR_REP_TRANSMOG_SETS, "REPLACE INTO `character_transmogrification_sets` (`owner`, `presetid`, `setname`, `setdata`) VALUES (?, ?, ?, ?)", CONNECTION_ASYNC);
